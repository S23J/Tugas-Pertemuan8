...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng rumah = new LatLng(-6.395495149645105, 106.79515193791742);
        ...
        LatLng sekolah = new LatLng(-6.223931708330396,  106.82678058305153);
        mMap.addMarker(new MarkerOptions().position(sekolah).title("Ini maps tempat kerja saya"));
